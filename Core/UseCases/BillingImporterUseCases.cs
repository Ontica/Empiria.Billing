...
*  Assembly : Financial.Billing.dll                      Pattern   : Use case interactor class               *
...
using System;
using System.IO;
using Empiria.Financial.Billing.Adapters;
using Empiria.Financial.Billing.Domain;
using Empiria.Services;

namespace Empiria.Financial.Billing.UseCases {
